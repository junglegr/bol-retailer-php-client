...
class Promotion extends AbstractModel
{
    ...
    public function getModelDefinition(): array
    {
        return [
            ...
            'countries' => [ 'model' => CountryCode::class, 'array' => true ],
    ...
    /**
     * Adds a new CountryCode to countries by countryCode.
    ...
    {
        $this->countries[] = CountryCode::constructFromArray(['countryCode' => $countryCode]);
    }
}
